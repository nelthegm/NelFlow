...
add("module version is 0.14.2", () => assert.equal(JSON.parse(rootFile("module.json")).version, "0.14.2"));
add("package version is 0.14.2", () => assert.equal(JSON.parse(rootFile("package.json")).version, "0.14.2"));
