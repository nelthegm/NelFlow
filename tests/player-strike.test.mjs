...
add("module version is 0.14.8", () => assert.equal(JSON.parse(rootFile("module.json")).version, "0.14.8"));
add("package version is 0.14.8", () => assert.equal(JSON.parse(rootFile("package.json")).version, "0.14.8"));
