...
add("module version is 0.9.2", () => assert.equal(JSON.parse(rootFile("module.json")).version, "0.9.2"));
add("package version is 0.9.2", () => assert.equal(JSON.parse(rootFile("package.json")).version, "0.9.2"));
