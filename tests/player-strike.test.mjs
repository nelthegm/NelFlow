...
add("module version is 0.6.4", () => assert.equal(JSON.parse(rootFile("module.json")).version, "0.6.4"));
add("package version is 0.6.4", () => assert.equal(JSON.parse(rootFile("package.json")).version, "0.6.4"));
