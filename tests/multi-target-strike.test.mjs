...
test("100. release metadata targets the 0.14.2 release", () => {
  const manifest = JSON.parse(source("module.json"));
  assert.equal(manifest.version, "0.14.2");
  assert.equal(manifest.download, "https://github.com/nelthegm/NelFlow/releases/download/v0.14.2/nelflow.zip");
});
