...
test("100. release metadata targets the eventual 0.9.2 RC", () => {
  const manifest = JSON.parse(source("module.json"));
  assert.equal(manifest.version, "0.9.2");
  assert.equal(manifest.download, "https://github.com/nelthegm/NelFlow/releases/download/v0.9.2-rc1/nelflow.zip");
});
