...
test("100. release metadata targets the 0.12.0 release", () => {
  const manifest = JSON.parse(source("module.json"));
  assert.equal(manifest.version, "0.12.0");
  assert.equal(manifest.download, "https://github.com/nelthegm/NelFlow/releases/download/v0.12.0/nelflow.zip");
});
