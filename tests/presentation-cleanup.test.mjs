...
test("0.14.1 metadata preserves GitHub distribution structure", () => {
  ...
  assert.equal(module.download, "https://github.com/nelthegm/NelFlow/releases/download/v0.14.1/nelflow.zip");
});
