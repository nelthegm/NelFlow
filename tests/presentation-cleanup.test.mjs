...
test("0.9.2 metadata preserves GitHub distribution structure", () => {
  ...
  assert.equal(module.download, "https://github.com/nelthegm/NelFlow/releases/download/v0.9.2-rc1/nelflow.zip");
});
