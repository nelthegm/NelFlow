...
test("0.13.0 metadata preserves GitHub distribution structure", () => {
  ...
  assert.equal(packageMetadata.version, "0.13.0");
  assert.equal(module.manifest, "https://raw.githubusercontent.com/nelthegm/NelFlow/main/module.json");
  assert.equal(module.download, "https://github.com/nelthegm/NelFlow/releases/download/v0.13.0/nelflow.zip");
});
