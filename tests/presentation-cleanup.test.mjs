...
test("0.14.7 metadata preserves GitHub distribution structure", () => {
  ...
  assert.equal(module.download, "https://github.com/nelthegm/NelFlow/releases/download/v0.14.7/nelflow.zip");
});
